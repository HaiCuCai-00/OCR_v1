...
if __name__ == "__main__":
    ...
    parser.add_argument("--input",default='/media/DATA_Old/hai_bk/hai/OCR/data/tht.jpg', help="Path to single image to be scanned")
    parser.add_argument("--type",default='cccd', help="Document type (cccc/cccd/cmnd/ttk/hc/dkkd/sohong...)")
    ...
    if "cccc" in l:
        ...
        res = pipeline.startC(img, args.type, args.output)
        print(res)
