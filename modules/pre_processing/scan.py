...
class DocScanner(object):
    ...
    def scan(self, image, output_path=None, binary=False, debug=True):
        ...
        if output_path is not None or debug:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--images", default=None, help="Directory of images to be scanned"
    )
    parser.add_argument(
        "--image", default=None, help="Path to single image to be scanned"
    )
    parser.add_argument(
        "--output", default="./results", help="Path to single image to be scanned"
    )
