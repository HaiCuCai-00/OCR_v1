...
class LanguageTransformer(nn.Module):
    def __init__(self, vocab_size, cfg):
        ...
        self.embed_tgt = nn.Embedding(vocab_size, cfg.model.transformer.d_model)
        self.pos_enc = PositionalEncoding(
            cfg.model.transformer.d_model,
            cfg.model.transformer.pos_dropout,
            cfg.model.transformer.max_seq_length,
        )
        ...
        self.transformer = nn.Transformer(
            ...
            cfg.model.transformer.num_encoder_layers,
            cfg.model.transformer.num_decoder_layers,
            cfg.model.transformer.dim_feedforward,
            cfg.model.transformer.trans_dropout,
        )

        self.fc = nn.Linear(cfg.model.transformer.d_model, vocab_size)
    ...
    def forward_encoder(self, src):
        src = self.pos_enc(src * math.sqrt(self.cfg.model.transformer.d_model))
    ...
    def forward_decoder(self, tgt, memory):
        ...
        tgt = self.pos_enc(
            self.embed_tgt(tgt) * math.sqrt(self.cfg.model.transformer.d_model)
        )
