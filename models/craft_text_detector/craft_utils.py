...
def load_craftnet_model():
    # get craft net path
    weight_path = config.CRAFT_PATH

    # load craft net
    from models.craft_text_detector.models.craftnet import CraftNet
...
def load_refinenet_model():
    ...
    weight_path = config.CRAFT_REFINER_PATH

    # load refine net
    from models.craft_text_detector.models.refinenet import RefineNet
